...
do_install () {
	...
	#rm ${D}${BINDIR}/kermit-sshsub /*!cbstodo: reconsider whether to remove this. The symlink is NOT there, so we cant remove. But should it be there? It is overwritten in the next line */
